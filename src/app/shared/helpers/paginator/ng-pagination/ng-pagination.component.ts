...
export class NgPagination implements OnChanges {
  ...
  @ContentChild(NgPaginationEllipsis, { static: false }) tplEllipsis: NgPaginationEllipsis | any;
  @ContentChild(NgPaginationFirst, { static: false }) tplFirst: NgPaginationFirst | any;
  @ContentChild(NgPaginationLast, { static: false }) tplLast: NgPaginationLast | any;
  @ContentChild(NgPaginationNext, { static: false }) tplNext: NgPaginationNext | any;
  @ContentChild(NgPaginationNumber, { static: false }) tplNumber: NgPaginationNumber | any;
  @ContentChild(NgPaginationPrevious, { static: false }) tplPrevious: NgPaginationPrevious | any;
   ...
   */
  @Input() collectionSize: number | any;
  ...
  selectPage(pageNumber: any): void { this._updatePages(pageNumber); }
