import { IAPIState } from './models/base.model';

export function baseFilter(entities: any[], requestObj: IAPIState) {

  // Filtration
  let entitiesResult = filterArray(entities, requestObj);
  // Search
  entitiesResult = searchInArray(entitiesResult, requestObj.search_string);
...
export function filterArray(incomingArray: any[], requestObj: IAPIState): any[] {
